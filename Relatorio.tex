...
\begin{figure}[H] 
    \centering 
    \includegraphics[scale = 0.7]{distribuicao_percentofbaseline.png} 
\end{figure}

\begin{figure}[H] 
    \centering 
    \includegraphics[scale = 0.6]{histograma_percentofbaseline.png} 
\end{figure}
...
\begin{figure}[H] 
    \centering 
    \includegraphics[scale = 0.6]{paises_percentofbaseline.png} 
\end{figure}
...
Por meio do trabalho, foi possível simular uma experiência profissional em que cada pessoa domina uma técnica. Dessa forma, a realização do trabalho foi mais fluida.
\par A respeito de tratamento e refinamento da base de dados, o time de Engenheiros de Dados apenas realizaram o SELECT das colunas necessárias para a aplicação, visto que não houve erro nos dados.
\end{document}
